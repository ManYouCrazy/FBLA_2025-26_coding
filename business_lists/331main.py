...
def find_password(username_to_check):
...
def uploadListing(new_job_desc):
    #adds the new 
...
userdata_file_data = open_json('business_lists/userdata.json')
...
while (logged_in != True):
    ...
    if (check_value(userdata_file_data,username)):
