...
#functions
    ...
    #hide or shows the text in the entrybox
    ...
    #creates the auth window and runs the auth windows functions
    def run(self):
        #configures/packs frames
        ...
        #packs the labels, entryboxes, and buttons
